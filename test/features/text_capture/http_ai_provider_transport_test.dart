...
void main() {
  ...
  test('OpenAI uses Responses structured output without response storage', () async {
  ...
  test('Anthropic uses Messages structured output and web direct-access opt in', () async {
    late http.Request captured;
    final client = MockClient((request) async {
      captured = request;
      return http.Response(
  ...
  test('compatible provider uses configured chat-completions endpoint', () async {
    late http.Request captured;
    final client = MockClient((request) async {
      captured = request;
      return http.Response(
  ...
  test('provider errors never expose raw response bodies or API keys', () async {
